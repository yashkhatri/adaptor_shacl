 ...
 */
    ...
    protected static void initServiceProviders (HttpServletRequest httpServletRequest)   
    {
		try {
	        ...
	        ServiceProviderInfo [] serviceProviderInfos = SampleAdaptorManager.getServiceProviderInfos(httpServletRequest);
	        ...
	        for (ServiceProviderInfo serviceProviderInfo : serviceProviderInfos) {
		        ...
		        if (! serviceProviders.containsKey(identifier)) {
					...
					String title = "SampleAdaptor Service Provider: " + serviceProviderName + "(" + identifier + ")";
					String description = "Service Provider for SampleAdaptor: " + serviceProviderName + "(" + identifier + ")";
