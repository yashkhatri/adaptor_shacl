    ...
    implements IAnotherResource
{
    ...
    public AnotherResource(final URI about)
           throws URISyntaxException
    {
        super(about);
    ...
    public String toString(boolean asLocalResource)
    {
        ...
        if (asLocalResource) {
            result = result + "{a Local AnotherResource Resource} - update AnotherResource.toString() to present resource as desired.";
