...
//        Try<Schema> schema_try = Schemas.fromString(streamAsCharSequence,
//            "TURTLE", "ShaClex", none);
//
...
//        }
        ...
        if (t.isSuccess()) {
            ...
            if (tstr.isSuccess()) {
                Try<RDFAsJenaModel> trdf = RDFAsJenaModel.fromChars(rdfstreamAsCharSequence,
                    "TURTLE", base);
                if (trdf.isSuccess()) {
