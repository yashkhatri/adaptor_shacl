...
<html>
  <head>
    ...
    <title>SampleAdaptor OSLC Adapter: Service Provider Catalog</title>
    <%--
    ...
    <div id="header">
      ...
      <table border="0" cellspacing="0" cellpadding="0" id="titles">
        <tr>
          <td id="title">
            <p>
              SampleAdaptor Service Provider Catalog: Service Provider Catalog
            </p>
          </td>
          <td id="information">
...
End of user code
      ...
      <p>Service Provider Catalog for SampleAdaptor</p>
