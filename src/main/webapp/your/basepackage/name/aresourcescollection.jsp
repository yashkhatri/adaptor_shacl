...
<%
    List<AResource> resources = (List<AResource>) request.getAttribute("resources");
...
<html>
	<head>
		...
		<title>AResource Query Capability</title>
		<%-- 
...
End of user code 
                ...
                <% for (AResource aResource : resources) { %>
